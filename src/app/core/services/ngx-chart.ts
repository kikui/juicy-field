...
export class NgxChartClass {
  // variables
  investParams: InvestParams | null;
  partialReinvest: PartialReinvest | null;
  ...
  constructor(investParams?: InvestParams, partialReinvest?: PartialReinvest, displayPanel?: DisplayPanel) {
    // options
    this.years = []
    this.displayPanel = displayPanel || null
    
    // variables
    this.investParams = investParams || null
    this.partialReinvest = partialReinvest || null
    this.ngxArrayData = [
